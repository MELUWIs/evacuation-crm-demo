...
Это публичная песочница, а не система аутентификации. Пароль находится в клиентском коде и не защищает доступ. Не вводите реальные сведения. Данные синтетические, изменения сохраняются только в localStorage этого браузера. Для восстановления используйте «Сбросить демо».
...
4. Проверить обновившийся одометр в автопарке и выручку в финансах.
